    ...
    <div class="max-w-7xl mx-auto space-y-6 pb-12">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
            ...
            <div class="flex items-center gap-3">
                ...
                <form action="{{ route('admin.pets.destroy', $pet->Ma_thu_cung) }}" method="POST" class="inline-block confirm-delete">
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="bg-red-600 text-white px-4 py-2 rounded-xl text-sm font-semibold hover:bg-red-700 hover:shadow-md transition-all shadow-sm flex items-center gap-2">
