    ...
    <div class="space-y-6" x-data="{ campaignToClose: null, campaignToDelete: null }">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div class="flex flex-col">
                <h2 class="text-2xl font-black text-slate-900 tracking-tight">Quản Lý Chiến Dịch</h2>
        ...
        <x-modal name="close-campaign-modal" focusable maxWidth="sm">
            <form method="POST" :action="`/admin/donation_campaigns/${campaignToClose}/close`" class="p-6 text-center">
                ...
                <h2 class="text-xl font-black text-slate-900 tracking-tight mb-2">Đóng Chiến dịch?</h2>
        ...
        <x-modal name="delete-campaign-modal" focusable maxWidth="sm">
            <form method="POST" :action="`/admin/donation_campaigns/${campaignToDelete?.id}`" class="p-6 text-center">
                ...
                <h2 class="text-xl font-black text-slate-900 tracking-tight mb-2">Xác nhận Xóa?</h2>
