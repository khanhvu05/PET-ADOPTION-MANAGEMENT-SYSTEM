                                ...
                                <td class="px-4 py-4 text-center whitespace-nowrap">
                                    <div class="relative inline-block">
                                        ...
                                        <div class="slot-dropdown hidden absolute right-0 top-full mt-1 w-48 bg-white border border-slate-200 rounded-lg shadow-xl z-[999] py-1">
                                            ...
                                            <button
                                                type="button"
                                                onclick="closeAllSlotDropdowns(); updateResult('{{ $s->Ma_lich_trinh }}', 'dat')"
                                            ...
                                            <button
                                                type="button"
                                                onclick="closeAllSlotDropdowns(); updateResult('{{ $s->Ma_lich_trinh }}', 'tu_choi')"
                                            ...
                                            <button
                                                type="button"
                                                onclick="closeAllSlotDropdowns(); updateResult('{{ $s->Ma_lich_trinh }}', 'vang_mat')"
