<x-guest-layout>
    ...
    <div class="mb-6 text-center">
        ...
        <p class="mt-1.5 text-[11px] text-text-muted font-bold px-4 leading-relaxed">
            Chào mừng bạn đến với PetJam — đăng ký để kết nối.
        </p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-4">
        ...
        <div class="space-y-1.5">
            <x-input-label for="name" value="HỌ TÊN ĐẦY ĐỦ" class="!text-[10px] !text-text-muted" />
            <div class="relative">
        ...
        <div class="space-y-1.5" x-data="{ show: false }">
            <x-input-label for="password" value="MẬT KHẨU" class="!text-[10px] !text-text-muted" />
            <div class="relative">
                <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                    <svg class="h-4 w-4 text-text-muted" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <!-- Confirm Password -->
        <div class="space-y-1.5" x-data="{ show: false }">
            <x-input-label for="password_confirmation" value="XÁC NHẬN MẬT KHẨU" class="!text-[10px] !text-text-muted" />
            <div class="relative">
                <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                    <svg class="h-4 w-4 text-text-muted" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
        ...
        <div class="flex items-center py-1">
            <label for="terms" class="relative flex items-center cursor-pointer group">
                ...
                <span class="ml-2.5 text-xs text-text-muted group-hover:text-white transition-colors font-medium">
                    Đồng ý với <a href="#" class="text-orange-brand hover:underline font-bold relative z-10 pointer-events-auto">Điều khoản & Bảo mật</a>.
                </span>
            </label>
        </div>
