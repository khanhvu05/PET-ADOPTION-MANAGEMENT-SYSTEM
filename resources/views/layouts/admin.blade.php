                    ...
                    <div class="flex items-center gap-5">
                        ...
                        <div class="flex items-center gap-3 relative" x-data="{ userMenuOpen: false }">
                            ...
                            <div x-show="userMenuOpen" @click.away="userMenuOpen = false"
                                 ...
                                 <div class="py-1">
                                     <a href="{{ route('admin.profile.edit') }}" class="flex items-center gap-2 px-4 py-2 text-sm text-slate-700 hover:bg-slate-50 hover:text-orange-brand transition-colors">
